...
class ResidualNetwork(nn.Module):
    def __init__(self) -> None:
        ...
        self.d1 = self.make_layer(2, 16, 1, 21, 10, 5) # 128
        self.d2 = self.make_layer(16, 32, 1, 11, 5, 1) # 64

        self.layer1 = self.make_layer(32, 64, 2, stride=1) # 32
        self.layer2 = self.make_layer(64, 128, 3, stride=1) # 16
        self.layer3 = self.make_layer(128, 256, 3, stride=1) # 8
